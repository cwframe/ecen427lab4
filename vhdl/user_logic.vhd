...
-- Date:              Thu Nov 05 12:14:27 2015 (by Create and Import Peripheral Wizard)
...
entity user_logic is
  ...
  (
	...
	INTERRUPT_INTERVAL			   : integer			  := 1000000;
...
begin
	...
	begin--First check for a reset
		...
		--load the timer
			...
			if slv_reg0(2) = '1' and timer = 0 then
				...
				--decrement the timer
				timer <= timer - 1;
			--otherwise leave the timer as it is
			else
				timer <= timer;
			end if;				
		end if;
	...
	PIT_INTERRUPT <= '1' when timer = 0 and slv_reg0(1) = '1' and slv_reg0(2) = '1' else '0';
