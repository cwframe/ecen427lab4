/*****************************************************************************
* Filename:          C:\Users\superman\Desktop\CTLAB_NES/drivers/dma_v1_00_a/src/dma.c
* Version:           1.00.a
* Description:       dma Driver Source File
* Date:              Wed Dec 09 14:10:20 2015 (by Create and Import Peripheral Wizard)
*****************************************************************************/
...
#define FRAME_BUFFER_0 0xC1000000
#define FRAME_BUFFER_SCREEN_CAPTURE (FRAME_BUFFER_0 + 8*640*480)
...
void DMA_ScreenCapture()
{
	Xil_Out32(XPAR_DMA_0_BASEADDR, FRAME_BUFFER_0);
	Xil_Out32(XPAR_DMA_0_BASEADDR+4, FRAME_BUFFER_SCREEN_CAPTURE);
	Xil_Out32(XPAR_DMA_0_BASEADDR+8, 640*480*4);
